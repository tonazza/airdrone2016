...
Public Class strumenti
    ...
    Public Class c_analogout
        ...
        Private Const indice As Integer = 3 'per il ventilatore ausiliario utilizzo uscita A3 con tensione 0-10V
        Private Const indice_serranda As Integer = 2 'per la serranda utilizzo uscita A2 con tensione 0-10V
        ...
        Public Function abilita_uscita_serranda() As Boolean

            Try
                dispositivo.outputs(indice_serranda).Enabled = True
                Return True

            Catch ex As Phidgets.PhidgetException
                Form1.PopolaDB_error("Errore interfaccia analogica - serranda")
                Return False
        ...
        Public Function disabilita_uscita_serranda() As Boolean

            Try
                dispositivo.outputs(indice_serranda).Enabled = False
                Return True
        ...
        Public Function imposta_tensione_serranda(ByVal volts As Double) As Boolean
            ...
            Else
                Try
                    dispositivo.outputs(indice_serranda).Voltage = volts
        ...
        Public Function imposta_percentuale_serranda(ByVal percentuale As Double) As Boolean
            Return imposta_tensione_serranda(percentuale / 10)
        End Function
